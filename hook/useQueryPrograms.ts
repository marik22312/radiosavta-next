...
export const prefetchQueryPrograms = (
  queryClient: QueryClient,
  req: QueryProgramsRequest
) => {
  return queryClient.prefetchInfiniteQuery(["query-programs", req], () =>
    queryPrograms(req)
  );
};

export const useQueryPrograms = (req: QueryProgramsRequest) => {
  const { data, ...rest } = useInfiniteQuery(["query-programs", req], () =>
    queryPrograms(req)
  );
