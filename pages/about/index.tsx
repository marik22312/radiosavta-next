        ...
        <section className={styles.storySection}>
          <div className="storyWrapper">
            <div className={cn(styles.firstSection, styles.section)}>
              <img
                src="https://res.cloudinary.com/marik-shnitman/image/upload/f_auto,q_auto/v1633457839/radiosavta/gallery/berech"
                alt="Our team image"
            ...
            <div className={cn(styles.fourthSection, styles.section)}>
              ...
              <div className={styles.storyImageWrapper}>
                <img
                  src="https://res.cloudinary.com/marik-shnitman/image/upload/f_auto,q_auto/v1606921730/radiosavta/gallery/radiosavta3"
                  alt="Our team image"
                  className={styles.backgroundImage}
                />
              </div>
